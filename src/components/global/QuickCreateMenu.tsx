...
import { Plus, Users, Building2, Factory, PackageSearch, ClipboardList, FileText, ShoppingCart, ClipboardCheck, Receipt, Wallet, Truck, CheckSquare } from "lucide-react";
import { Button } from "@/components/ui/button";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger } from "@/components/ui/dropdown-menu";

const ITEMS: ReadonlyArray<{ to: string; label: string; icon: typeof Users; group: "Master" | "Sales" | "Ops" }> = [
      ...
      <DropdownMenuContent align="end" className="w-56">
        {groups.map((g, gi) => (
          <div key={g}>
            ...
            <DropdownMenuLabel className="text-xs uppercase tracking-wide text-muted-foreground">{g}</DropdownMenuLabel>
