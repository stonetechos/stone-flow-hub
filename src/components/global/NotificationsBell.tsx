    ...
    <Popover>
      ...
      <PopoverContent align="end" className="w-80 p-0">
        <div className="flex items-center justify-between border-b border-border px-3 py-2">
          ...
          <Button variant="ghost" size="sm" className="h-7 px-2 text-xs" onClick={markAll}>Mark all read</Button>
        </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="shrink-0 text-[11px] text-muted-foreground">{formatRelative(n.at)}</span>
                  </div>
        ...
        <div className="border-t border-border px-3 py-2 text-right">
          <Badge variant="secondary" className="text-[10px]">Preview — no backend yet</Badge>
        </div>
      </PopoverContent>
    </Popover>
  );
