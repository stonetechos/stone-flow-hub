  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button size="sm">
          <Plus className="mr-1 h-4 w-4" /> Daily report
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Daily site progress</DialogTitle>
        </DialogHeader>
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            ...
            <Input
              type="number"
              step="0.01"
              value={form.area_completed_sqft}
              onChange={(e) => setForm({ ...form, area_completed_sqft: e.target.value })}
            />
          </div>
          <div className="space-y-1">
            ...
            <Input
              type="number"
              value={form.labour_present}
              onChange={(e) => setForm({ ...form, labour_present: e.target.value })}
            />
          </div>
          ...
          <div className="col-span-2 space-y-1">
            ...
            <Textarea
              rows={2}
              value={form.balance_work}
              onChange={(e) => setForm({ ...form, balance_work: e.target.value })}
            />
          </div>
          <div className="space-y-1">
            ...
            <Textarea
              rows={2}
              value={form.material_consumed}
              onChange={(e) => setForm({ ...form, material_consumed: e.target.value })}
            />
          </div>
          <div className="space-y-1">
            ...
            <Textarea
              rows={2}
              value={form.material_shortage}
              onChange={(e) => setForm({ ...form, material_shortage: e.target.value })}
            />
          </div>
          <div className="space-y-1">
          ...
          <div className="col-span-2 space-y-1">
            ...
            <Textarea
              rows={2}
              value={form.supervisor_remarks}
              onChange={(e) => setForm({ ...form, supervisor_remarks: e.target.value })}
            />
          </div>
        </div>
        <DialogFooter>
