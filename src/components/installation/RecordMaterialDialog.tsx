  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button size="sm" variant="outline"><PackagePlus className="mr-1 h-4 w-4" /> Record material</Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader><DialogTitle>Record installation material</DialogTitle></DialogHeader>
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            ...
            <Input value={description} onChange={(e) => setDescription(e.target.value)} placeholder="e.g. 20mm Galaxy slab" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1">
              <Label>Unit</Label>
              <Input value={unit} onChange={(e) => setUnit(e.target.value)} placeholder="sqft / nos" />
            </div>
          </div>
          <div className="space-y-1">
            <Label>Notes</Label>
