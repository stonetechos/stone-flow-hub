  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <>
            <Button variant="ghost" onClick={() => nav({ to: "/dispatch" })}><ArrowLeft className="mr-2 h-4 w-4" /> Back</Button>
            <Button onClick={() => nav({ to: "/dispatch/$id/edit", params: { id } })}><Pencil className="mr-2 h-4 w-4" /> Edit</Button>
          </>
        }
      />
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          ...
          <NotesPanel table="dispatches" id={r.id} value={r.notes} invalidateKey={qk.dispatch.byId(r.id)} />
