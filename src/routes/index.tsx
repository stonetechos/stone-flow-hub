...
function HomePage() {
  ...
  // -------------------------------------------------------------
  return (
    <div className="min-h-screen bg-stone-50/40 dark:bg-slate-950 text-foreground antialiased pb-20 sm:pb-12">
      ...
      <header className="sticky top-0 z-40 border-b border-border/80 bg-background/90 backdrop-blur-md shadow-2xs">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-amber-600 via-amber-700 to-stone-900 text-white font-black text-lg shadow-sm ring-1 ring-amber-500/30">
              ST
            </div>
            <div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[11px] text-muted-foreground">Select multiple</span>
                      </div>
                    ...
                    <div className="space-y-2 pt-2 border-t border-border/80">
                      ...
                      {photos.length < 10 && (
                        <div
                          ...
                          className="rounded-xl border border-dashed border-primary/40 hover:border-primary bg-muted/20 hover:bg-muted/40 p-3 text-center cursor-pointer transition-all flex items-center justify-center gap-2 text-xs text-muted-foreground hover:text-foreground"
                        >
                          {isProcessingPhotos ? (
                        ...
                        <div>
                          ...
                          <div className="flex items-center">
                            ...
                            <Input
                              ...
                              className="h-9 text-xs font-medium rounded-l-none border-l-0 border-emerald-300 focus-visible:ring-emerald-500 dark:border-emerald-800"
                            />
                          </div>
                        </div>
                      ...
                      <div className="space-y-1.5 pt-1">
                        <div className="flex items-center justify-between text-[11px]">
                          <span className="font-semibold text-foreground flex items-center gap-1">
                            <CalendarIcon className="h-3 w-3 text-primary" /> Required Completion
