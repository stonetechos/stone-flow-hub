...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      vendors: {
        Row: {
          ...
          pincode: string | null;
          preferred_transport: Database["public"]["Enums"]["preferred_transport"] | null;
      ...
      vie_actions: {
        Row: {
          ...
          entities: Json;
          error_message: string | null;
          execution_mode: Database["public"]["Enums"]["vie_execution_mode"] | null;
          id: string;
          intent: string;
          language: string;
    ...
    Enums: {
      ...
      employment_status: "active" | "on_leave" | "notice" | "terminated" | "resigned";
      ...
      installation_status:
        ...
        | "replaced"
        | "returned";
      invoice_status: "draft" | "sent" | "partially_paid" | "paid" | "cancelled" | "overdue";
      ...
      payment_link_status: "created" | "sent" | "partially_paid" | "paid" | "cancelled" | "expired";
      payment_method:
        | "razorpay"
        | "bank_transfer"
        | "upi_manual"
      ...
      product_unit: "sqft" | "sqm" | "piece" | "slab" | "linear_ft" | "linear_m" | "cbm";
      production_status: "planned" | "in_progress" | "on_hold" | "completed" | "cancelled";
      project_type:
        | "residential"
        | "commercial"
        | "hospitality"
      ...
      vendor_request_status: "pending" | "submitted" | "declined" | "expired" | "closed_lost";
      vie_action_status:
        | "pending"
        | "planned"
      ...
      workforce_task_status: "pending" | "in_progress" | "completed" | "deferred" | "cancelled";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      enquiry_priority: ["low", "normal", "high", "urgent"],
      estimate_document_kind: ["customer_pdf", "cost_sheet_pdf", "whatsapp_text", "email_html"],
      estimate_item_category: ["material", "manufacturing", "installation", "consumable", "other"],
      estimate_status: [
        "draft",
        "sent",
        "accepted",
      ...
      qc_outcome: ["pass", "fail", "rework", "approved", "rejected", "not_checked"],
      quote_status: ["draft", "sent", "accepted", "rejected", "expired", "converted"],
      rfq_status: ["draft", "sent", "partially_received", "fully_received", "closed", "cancelled"],
      sales_order_status: [
        "draft",
        "confirmed",
        "in_production",
